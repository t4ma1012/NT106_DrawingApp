...
namespace DrawingClient.Drawing
{
    public class CanvasManager
    {
        ...
        public void ApplyDrawAction(DrawAction action)
        {
            ...
            ApplyRemoteDraw(new DrawPayload { X1 = action.X1, Y1 = action.Y1, X2 = action.X2, Y2 = action.Y2, ColorARGB = action.ColorARGB, Thickness = action.Thickness });
        }
        ...
        {
            try { graphics.Clear(Color.Transparent); canvas.Invalidate(); } catch { }
        }
